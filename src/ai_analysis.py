...
Не ставь 0.0, если присутствует совпадение ключевых смысловых элементов.
При частичном совпадении смысла используй минимум 0.3, чаще 0.5.
Различия во времени/аспекте/согласовании не снижай ниже 0.7 при сохранении смысла.
...
Давай конкретные советы по улучшению понимания, а не по грамматике."""
    ...
    def _normalize_score(self, score: float) -> float:
        ...
        # Используем пороговые диапазоны для нормализации (мягче шкала)
        if score <= 0.15:
